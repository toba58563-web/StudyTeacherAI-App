...
export default function AdminPage() {
  ...
  const handleGoogleAdminLogin = async () => {
    ...
    try {
      ...
      setLoginError(err.message || "An error occurred with Google Sign-In");
    }
  };
        ...
        <div className="w-full max-w-sm bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="space-y-6">
            <button
              ...
              className="w-full bg-white text-gray-900 hover:bg-gray-100 font-medium py-3 rounded-xl transition-colors flex items-center justify-center space-x-3 shadow-md"
            >
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-2 bg-slate-900 text-slate-500 uppercase tracking-widest">
                  Manual Override
                </span>
              </div>
            </div>

            <form onSubmit={handleAdminLogin} className="space-y-4 relative opacity-70 focus-within:opacity-100 transition-opacity">
              <div>
                <div className="relative">
              ...
              <button
                type="submit"
                className="w-full bg-slate-800 hover:bg-slate-700 text-white font-medium py-3 rounded-xl transition-colors flex items-center justify-center space-x-2 border border-slate-700"
              >
